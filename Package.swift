...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Telepath",
            url: "https://github.com/AppTelepath/AppTelepath-iOS/releases/download/3.7.0/Telepath-3.7.0.zip",
            checksum: "098815302240d45bdb9a3c075f31c2ba81dd0b58eb9213f79d65da3e4b6855b5"
        ),
