...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Telepath",
            url: "https://github.com/AppTelepath/AppTelepath-iOS/releases/download/3.8.0/Telepath-3.8.0.zip",
            checksum: "70d45b5a9f2809a680dc6e90b5d86fb65c9f1b28ee1b47886797e3751d709664"
        ),
